...
public class EvalBogglePlayer2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        runtime.gc();
        long memoryI = (runtime.totalMemory() - runtime.freeMemory());
        System.out.println("Used memory before pre-processing in bytes (not part of score): " + memoryI);
        ...
        long startPreProcTime = System.nanoTime();
        BogglePlayer player = new BogglePlayer(args[0]);
        //long endPreProcTime = bean.getCurrentThreadCpuTime();
        long endPreProcTime = System.nanoTime();

        long memoryF = (runtime.totalMemory() - runtime.freeMemory());
        System.out.println("Used memory after pre-processing in bytes (not part of score): " + memoryF);
        
        long memoryTotal =  memoryF - memoryI;
        System.out.println("BogglePlayer memory from pre-processing in bytes: " + memoryTotal);
